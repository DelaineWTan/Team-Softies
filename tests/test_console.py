...
class TestStringMethods(unittest.TestCase):
    @patch('builtins.input', side_effect=['1', '3', '3'])  # mock input order (edit, return to menu, quit)
    def test_menu_editor_back_quit(self, mock_input):
        with patch('sys.stdout', new_callable=StringIO) as mock_stdout:  # extract all print on screen into a string
            menu = UserMenu()
    ...
    def test_quit_game_immediately(self, mock_input):
        ...
        self.assertEqual(after_output, "Welcome to our text-based RPG maker!\n1. Editor mode\n2. Player mode\n3. Quit")
